  ...
  return (
    <div className="flex items-center gap-3">
      <button
        ...
        onClick={() => mutate()}
        disabled={isPending}
        className="cursor-pointer rounded-lg bg-gray-900 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-gray-700 disabled:cursor-not-allowed disabled:opacity-60"
      >
